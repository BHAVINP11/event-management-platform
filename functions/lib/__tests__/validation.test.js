...
describe('Organization Validation', () => {
    describe('validateCreateOrganizationInput', () => {
        it('should accept valid input', () => {
            ...
            const result = (0, createOrganization_1.validateCreateOrganizationInput)(input);
        ...
        it('should reject missing name', () => {
            ...
            expect(() => (0, createOrganization_1.validateCreateOrganizationInput)(input)).toThrow(validation_1.ValidationError);
        });
    ...
    describe('getOrganizationMembershipId', () => {
        it('should create deterministic membership ID', () => {
            const id = (0, createOrganization_1.getOrganizationMembershipId)('org-123', 'user-456');
...
describe('Event Validation', () => {
    describe('validateCreateIndividualEventInput', () => {
        it('should accept valid input', () => {
            ...
            const result = (0, createIndividualEvent_1.validateCreateIndividualEventInput)(input);
    ...
    describe('getEventMembershipId', () => {
        it('should create deterministic membership ID', () => {
            const id = (0, createIndividualEvent_1.getEventMembershipId)('event-123', 'user-456');
