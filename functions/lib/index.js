...
exports.onCreateIndividualEvent = exports.onCreateOrganization = void 0;
...
exports.onCreateIndividualEvent = functions.https.onCall(async (data, context) => {
    ...
    try {
        // Validate input
        const validatedInput = (0, createIndividualEvent_1.validateCreateIndividualEventInput)(data);
        // Call business logic with auth context
        const result = await (0, createIndividualEvent_1.createIndividualEvent)(db, { uid: context.auth.uid }, validatedInput);
        return result;
    }
    catch (error) {
        const errorResponse = mapErrorToResponse(error);
